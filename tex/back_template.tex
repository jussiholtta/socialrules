...
\usepackage[paperheight=59mm,paperwidth=88mm,top=2mm,bottom=2mm,right=2mm,left=2mm,heightrounded]{geometry}
\usepackage{graphicx}
\usepackage{tabularx}
\usepackage{xcolor}
...
\raisebox{0.2\height}{
        \includegraphics[width=6mm]{images/TEMPLATELEVEL} 
} & &
\raisebox{0.2\height}{
\includegraphics[width=6mm]{images/TEMPLATEGAMEMODE1} 
}
\end{tabularx}
\vspace*{\fill}
\begin{tabularx}{84mm}{l X r}
...
&
\includegraphics[width=6mm]{images/TEMPLATEGAMEMODE2}
\end{tabularx}
\vspace*{\fill}
\begin{tabularx}{84mm}{l X r}
& & \raisebox{-1\height}{
\includegraphics[width=6mm]{images/TEMPLATEGAMEMODE3}
} \\
\end{tabularx}
\end{center}
